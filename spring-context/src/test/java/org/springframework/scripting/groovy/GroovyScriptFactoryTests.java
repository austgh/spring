...
public class GroovyScriptFactoryTests {
	...
	public void testStaticScript() throws Exception {
		...
		assertFalse(messenger.equals(calc));
		assertTrue(messenger.hashCode() != calc.hashCode());
		assertFalse(messenger.toString().equals(calc.toString()));

		String desiredMessage = "Hello World!";
		assertEquals("Message is incorrect", desiredMessage, messenger.getMessage());

		assertTrue(ctx.getBeansOfType(Calculator.class).containsValue(calc));
		assertTrue(ctx.getBeansOfType(Messenger.class).containsValue(messenger));
	}
	...
	public void testRefreshableFromTagProxyTargetClass() throws Exception {
		...
		assertTrue(ctx.getBeansOfType(ConcreteMessenger.class).containsValue(messenger));
