...
public class DateTimeFormattingTests {
	...
	public void testBindPeriod() {
		...
		binder.bind(propertyValues);
		assertEquals(0, binder.getBindingResult().getErrorCount());
        assertEquals("P6Y3M1D", binder.getBindingResult().getFieldValue("period").toString());
	}
	...
	public void testBindDuration() {
		...
		binder.bind(propertyValues);
		assertEquals(0, binder.getBindingResult().getErrorCount());
        assertEquals("PT8H6M12.345S", binder.getBindingResult().getFieldValue("duration").toString());
	}
	...
	public void testBindYear() {
		...
		binder.bind(propertyValues);
		assertEquals(0, binder.getBindingResult().getErrorCount());
        assertEquals("2007", binder.getBindingResult().getFieldValue("year").toString());
	}
	...
	public void testBindMonth() {
		...
		binder.bind(propertyValues);
		assertEquals(0, binder.getBindingResult().getErrorCount());
        assertEquals("JULY", binder.getBindingResult().getFieldValue("month").toString());
	}
	...
	public void testBindYearMonth() {
		...
		binder.bind(propertyValues);
		assertEquals(0, binder.getBindingResult().getErrorCount());
        assertEquals("2007-12", binder.getBindingResult().getFieldValue("yearMonth").toString());
	}
	...
	public void testBindMonthDay() {
		...
		binder.bind(propertyValues);
		assertEquals(0, binder.getBindingResult().getErrorCount());
        assertEquals("--12-03", binder.getBindingResult().getFieldValue("monthDay").toString());
	}
