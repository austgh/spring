...
public class BeanNamePointcutTests {
	...
	public void testMatchingFactoryBeanObject() {
		...
		assertFalse("FactoryBean itself must *not* be advised", fb instanceof Advised);
	}

	@Test
	public void testMatchingFactoryBeanItself() {
		assertFalse("Matching bean must *not* be advised (proxied)", this.testFactoryBean2 instanceof Advised);
