...
public class NestedConfigurationClassTests {
	...
	public void twoLevelsDeepWithInheritance() {
        ...
        assertNotSame(config, ctx.getBean(S1Config.class));
		TestBean tb = ctx.getBean("l0Bean", TestBean.class);
        assertSame(tb, ctx.getBean("l0Bean", TestBean.class));
        ...
        assertSame(ob, ctx.getBean("overrideBean", TestBean.class));
        ...
        assertNotSame(pb1.getFriends().iterator().next(), pb2.getFriends().iterator().next());
	}
	...
	public void twoLevelsDeepWithInheritanceAndScopedProxy() {
        ...
        assertSame(config, ctx.getBean(S1ConfigWithProxy.class));
		TestBean tb = ctx.getBean("l0Bean", TestBean.class);
        assertSame(tb, ctx.getBean("l0Bean", TestBean.class));
