...
public class StaticMessageSourceTests extends AbstractApplicationContextTests {
	...
	public void getMessageWithDefaultPassedInAndFoundInMsgCatalog() {
		// Try with Locale.US
        assertEquals("valid msg from staticMsgSource with default msg passed in returned msg from msg catalog for " +
                "Locale.US", "This is a test message in the message catalog with no args.", sac.getMessage("message" +
                ".format.example2", null, "This is a default msg if not found in MessageSource.", Locale.US));
	}

	@Test
	public void getMessageWithDefaultPassedInAndNotFoundInMsgCatalog() {
		// Try with Locale.US
        assertEquals("bogus msg from staticMsgSource with default msg passed in returned default msg for Locale.US",
                "This is a default msg if not found in MessageSource.", sac.getMessage("bogus.message", null, "This " +
                        "is a default msg if not found in MessageSource.", Locale.US));
	}
	...
	public void getMessageWithNoDefaultPassedInAndFoundInMsgCatalog() {
        ...
        assertEquals("msg from staticMsgSource for Locale.US that requires no args is as expected", "This is a test " +
                "message in the message catalog with no args.", sac.getMessage("message.format.example2", null,
                Locale.US));
	}
	...
	public void messageSourceResolvable() {
        ...
        assertEquals("correct message retrieved", MSG_TXT3_US, sac.getMessage(resolvable1, Locale.US));
        ...
        assertEquals("correct message retrieved", MSG_TXT2_US, sac.getMessage(resolvable2, Locale.US));
        ...
        assertEquals("correct message retrieved", "default", sac.getMessage(resolvable3, Locale.US));
