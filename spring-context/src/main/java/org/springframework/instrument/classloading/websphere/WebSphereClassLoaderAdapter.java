...
class WebSphereClassLoaderAdapter {
	...
	private final Class<?> wsPreProcessorClass;

	private final Method addPreDefinePlugin;

	private final Constructor<? extends ClassLoader> cloneConstructor;

	private final Field transformerList;
