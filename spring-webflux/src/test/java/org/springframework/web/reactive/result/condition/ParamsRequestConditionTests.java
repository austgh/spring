...
public class ParamsRequestConditionTests {
	...
	public void paramEquals() {
        ...
        assertNotEquals(new ParamsRequestCondition("foo"), new ParamsRequestCondition("bar"));
        assertNotEquals(new ParamsRequestCondition("foo"), new ParamsRequestCondition("FOO"));
		assertEquals(new ParamsRequestCondition("foo=bar"), new ParamsRequestCondition("foo=bar"));
        assertNotEquals(new ParamsRequestCondition("foo=bar"), new ParamsRequestCondition("FOO=bar"));
	}
