...
public class ViewResolverTests {
	...
	private void doTestUrlBasedViewResolverWithoutPrefixes(UrlBasedViewResolver vr) throws Exception {
		...
		assertEquals("Correct tb attribute", tb, request.getAttribute("tb"));
	...
	public void testInternalResourceViewResolverWithAttributes() throws Exception {
		...
		assertEquals("Correct tb attribute", tb, request.getAttribute("tb"));
		assertNull("Correct rc attribute", request.getAttribute("rc"));
			...
			public RequestDispatcher getRequestDispatcher(String path) {
				return new MockRequestDispatcher(path) {
					...
					public void forward(ServletRequest forwardRequest, ServletResponse forwardResponse) {
						assertNull("Correct rc attribute", forwardRequest.getAttribute("rc"));
	...
	public void testXmlViewResolver() throws Exception {
		...
		assertEquals("Correct view class", TestView.class, view1.getClass());
		assertEquals("Correct URL", "/example1.jsp", ((InternalResourceView) view1).getUrl());

		View view2 = vr.resolveViewName("example2", Locale.getDefault());
		assertEquals("Correct view class", JstlView.class, view2.getClass());
		assertEquals("Correct URL", "/example2new.jsp", ((InternalResourceView) view2).getUrl());
		...
		assertEquals("Correct tb attribute", tb, request.getAttribute("tb"));
		assertEquals("Correct test1 attribute", "testvalue1", request.getAttribute("test1"));
		assertEquals("Correct test2 attribute", testBean, request.getAttribute("test2"));
		...
		assertEquals("Correct tb attribute", tb, request.getAttribute("tb"));
		assertEquals("Correct test1 attribute", "testvalue1", request.getAttribute("test1"));
		assertEquals("Correct test2 attribute", "testvalue2", request.getAttribute("test2"));
	}
	...
	public void testXmlViewResolverDefaultLocation() {
		StaticWebApplicationContext wac = new StaticWebApplicationContext() {
			...
			protected Resource getResourceByPath(String path) {
				assertEquals("Correct default location", XmlViewResolver.DEFAULT_LOCATION, path);
