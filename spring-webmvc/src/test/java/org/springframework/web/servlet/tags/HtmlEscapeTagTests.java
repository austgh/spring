...
public class HtmlEscapeTagTests extends AbstractTagTests {
	...
	public void htmlEscapeTag() throws JspException {
		...
		assertFalse("Correct default", tag.getRequestContext().isDefaultHtmlEscape());
		assertFalse("Correctly applied", testTag.isHtmlEscape());
		...
		assertEquals("Correct doStartTag return value", Tag.EVAL_BODY_INCLUDE, tag.doStartTag());
		assertFalse("Correctly disabled", tag.getRequestContext().isDefaultHtmlEscape());
		assertFalse("Correctly applied", testTag.isHtmlEscape());
