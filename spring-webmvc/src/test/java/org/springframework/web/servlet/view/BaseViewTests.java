...
public class BaseViewTests {
	...
	public void attributeCSVParsingValid() {
		...
		assertEquals(2, v.getStaticAttributes().size());
		assertEquals("bar", v.getStaticAttributes().get("foo"));
		assertEquals("kong", v.getStaticAttributes().get("king"));
	}
	...
	public void attributeCSVParsingValidWithWeirdCharacters() {
		...
		assertEquals(3, v.getStaticAttributes().size());
		assertEquals(v.getStaticAttributes().get("foo"), fooval);
		assertEquals(v.getStaticAttributes().get("king"), kingval);
	}
	...
	private static class TestView extends AbstractView {
		...
		protected void initApplicationContext() throws ApplicationContextException {
			...
			assertSame(getApplicationContext(), wac);
		}
	}
