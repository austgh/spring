...
public class ControllerTests {
	...
	public void parameterizableViewController() throws Exception {
        ...
        assertEquals("model has no data", 0, mv.getModel().size());
        assertEquals("model has correct viewname", mv.getViewName(), viewName);
        assertEquals("getViewName matches", pvc.getViewName(), viewName);
	}
