...
public class InterceptorRegistryTests {
	...
	public void addInterceptor() {
		...
		assertEquals(Collections.singletonList(this.interceptor1), interceptors);
	}
	...
	public void addInterceptorsWithUrlPatterns() {
		...
		assertEquals(Collections.singletonList(this.interceptor1), getInterceptorsForPath("/path1/test"));
		assertEquals(Collections.singletonList(this.interceptor2), getInterceptorsForPath("/path2"));
