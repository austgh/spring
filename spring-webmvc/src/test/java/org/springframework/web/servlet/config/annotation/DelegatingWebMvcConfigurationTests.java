...
public class DelegatingWebMvcConfigurationTests {
	...
	public void configurePathMatch() throws Exception {
		...
		assertTrue("PathMatchConfigurer should configure RegisteredSuffixPatternMatch",
				handlerMapping.useRegisteredSuffixPatternMatch());
		assertTrue("PathMatchConfigurer should configure SuffixPatternMatch", handlerMapping.useSuffixPatternMatch());
		assertFalse("PathMatchConfigurer should configure TrailingSlashMatch", handlerMapping.useTrailingSlashMatch());
