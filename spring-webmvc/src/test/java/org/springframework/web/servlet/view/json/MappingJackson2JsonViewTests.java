...
public class MappingJackson2JsonViewTests {
	...
	public void isExposePathVars() {
		assertFalse("Must not expose path variables", view.isExposePathVariables());
	}
	...
	public void renderWithJsonp() throws Exception {
		...
		this.view.setJsonpParameterNames(new LinkedHashSet<>(Collections.singletonList("jsonp")));
	...
	public static class TestBeanSimple {
		...
		private final String property1 = "foo";

		private final boolean test = false;

		@JsonView(MyJacksonView2.class)
		private final String property2 = "boo";

		private final TestChildBean child = new TestChildBean();
