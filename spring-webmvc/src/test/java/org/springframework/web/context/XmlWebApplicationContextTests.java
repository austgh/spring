...
public class XmlWebApplicationContextTests extends AbstractApplicationContextTests {
	...
	@Override
	public void count() {
		assertEquals("should have 14 beans, not " + this.applicationContext.getBeanDefinitionCount(), 14,
	...
	public void contextNesting() {
		...
		assertFalse("Custom BeanPostProcessor not applied", rod.getFriends().contains("myFriend"));
