...
public class AnnotationMetadataTests {
	...
	private void doTestAnnotationInfo(AnnotationMetadata metadata) {
		...
		assertThat(new HashSet<>(allMeta), is(equalTo(new HashSet<Object>(Collections.singletonList("direct")))));
		...
		{ // perform tests with classValuesAsString = false (the default)
			...
			assertEquals(specialAttrs.getEnum("state"), Thread.State.NEW);

			AnnotationAttributes nestedAnno = specialAttrs.getAnnotation("nestedAnno");
			assertThat("na", is(nestedAnno.getString("value")));
			assertEquals(nestedAnno.getEnum("anEnum"), SomeEnum.LABEL1);
			...
			assertEquals(nestedAnnoArray[0].getEnum("anEnum"), SomeEnum.DEFAULT);
			...
			assertEquals(nestedAnnoArray[1].getEnum("anEnum"), SomeEnum.LABEL2);
			...
			assertEquals(optional.getEnum("anEnum"), SomeEnum.DEFAULT);
			...
			assertEquals(optionalArray[0].getEnum("anEnum"), SomeEnum.DEFAULT);
