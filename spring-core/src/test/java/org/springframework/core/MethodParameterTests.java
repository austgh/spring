...
public class MethodParameterTests {
	...
	public void testEquals() throws NoSuchMethodException {
        ...
        assertNotEquals(stringParameter, longParameter);
        assertNotEquals(stringParameter, intReturnType);
        assertNotEquals(longParameter, stringParameter);
        assertNotEquals(longParameter, intReturnType);
        assertNotEquals(intReturnType, stringParameter);
        assertNotEquals(intReturnType, longParameter);
