...
public class GenericTypeResolverTests {
	...
	public void methodReturnTypes() {
		...
		assertNull(resolveReturnTypeArgument(findMethod(MyTypeWithMethods.class, "raw"), MyInterfaceType.class));
		assertNull(resolveReturnTypeArgument(findMethod(MyTypeWithMethods.class, "object"), MyInterfaceType.class));
	}
