...
public class MessageListenerTestContainer implements MessageListenerContainer, InitializingBean, DisposableBean {
	...
	public String toString() {
        String sb = "TestContainer{" + "endpoint=" + this.endpoint +
                ", startInvoked=" + this.startInvoked +
                ", initializationInvoked=" + this.initializationInvoked +
                ", stopInvoked=" + this.stopInvoked +
                ", destroyInvoked=" + this.destroyInvoked +
                '}';
		return sb;
	}
