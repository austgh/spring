...
public class NativeMessageHeaderAccessorTests {
	...
	public void createFromMessageAndModify() {
		...
		assertEquals(Collections.singletonList("BAR"), actualNativeHeaders.get("foo"));
		assertEquals(Collections.singletonList("baz"), actualNativeHeaders.get("bar"));
	}
	...
	public void setNativeHeader() {
		...
		assertEquals(Collections.singletonList("baz"), headers.getNativeHeader("foo"));
	}
