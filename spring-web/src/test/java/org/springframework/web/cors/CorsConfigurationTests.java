...
public class CorsConfigurationTests {
	...
	public void setValues() {
		...
		assertEquals(Collections.singletonList("*"), config.getAllowedHeaders());
		config.addAllowedMethod("*");
		assertEquals(Collections.singletonList("*"), config.getAllowedMethods());
	...
	public void combineWithNullProperties() {
		...
		assertEquals(Collections.singletonList("*"), config.getAllowedOrigins());
		assertEquals(Collections.singletonList("header1"), config.getAllowedHeaders());
		assertEquals(Collections.singletonList("header3"), config.getExposedHeaders());
		assertEquals(Collections.singletonList(HttpMethod.GET.name()), config.getAllowedMethods());
		assertEquals(new Long(123), config.getMaxAge());
		assertTrue(config.getAllowCredentials());
	}
	...
	public void combineWithDefaultPermitValues() {
		...
		assertEquals(Collections.singletonList("https://domain.com"), combinedConfig.getAllowedOrigins());
		assertEquals(Collections.singletonList("header1"), combinedConfig.getAllowedHeaders());
		assertEquals(Collections.singletonList(HttpMethod.PUT.name()), combinedConfig.getAllowedMethods());
	...
	public void combineWithAsteriskWildCard() {
		...
		other.addAllowedMethod(HttpMethod.PUT.name());
		CorsConfiguration combinedConfig = config.combine(other);
		assertEquals(Collections.singletonList("*"), combinedConfig.getAllowedOrigins());
		assertEquals(Collections.singletonList("*"), combinedConfig.getAllowedHeaders());
		assertEquals(Collections.singletonList("*"), combinedConfig.getAllowedMethods());
		combinedConfig = other.combine(config);
		assertEquals(Collections.singletonList("*"), combinedConfig.getAllowedOrigins());
		assertEquals(Collections.singletonList("*"), combinedConfig.getAllowedHeaders());
		assertEquals(Collections.singletonList("*"), combinedConfig.getAllowedMethods());
	...
	public void checkMethodAllowed() {
		...
		assertEquals(Collections.singletonList(HttpMethod.GET), config.checkHttpMethod(HttpMethod.GET));
	...
	public void checkHeadersAllowed() {
		...
		config.addAllowedHeader("header1");
		config.addAllowedHeader("header2");
		assertEquals(Collections.singletonList("header1"), config.checkHeaders(Collections.singletonList("header1")));
	...
	public void checkHeadersNotAllowed() {
		...
		assertNull(config.checkHeaders(Collections.singletonList("header1")));
