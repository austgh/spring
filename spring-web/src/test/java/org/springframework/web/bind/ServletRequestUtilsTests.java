...
public class ServletRequestUtilsTests {
	...
	public void testIntParameter() throws ServletRequestBindingException {
		...
		assertNull(ServletRequestUtils.getIntParameter(request, "param3"));
	...
	public void testLongParameter() throws ServletRequestBindingException {
		...
		assertNull(ServletRequestUtils.getLongParameter(request, "param3"));
	...
	public void testFloatParameter() throws ServletRequestBindingException {
		...
		assertEquals(ServletRequestUtils.getFloatParameter(request, "param1"), new Float(5.5f));
		assertEquals(5.5f, ServletRequestUtils.getFloatParameter(request, "param1", 6.5f), 0.0);
		assertEquals(5.5f, ServletRequestUtils.getRequiredFloatParameter(request, "param1"), 0.0);

		assertEquals(6.5f, ServletRequestUtils.getFloatParameter(request, "param2", 6.5f), 0.0);
		try {
		...
		assertNull(ServletRequestUtils.getFloatParameter(request, "param3"));
		assertEquals(6.5f, ServletRequestUtils.getFloatParameter(request, "param3", 6.5f), 0.0);
		try {
	...
	public void testDoubleParameter() throws ServletRequestBindingException {
		...
		assertEquals(ServletRequestUtils.getDoubleParameter(request, "param1"), new Double(5.5));
		assertEquals(5.5, ServletRequestUtils.getDoubleParameter(request, "param1", 6.5), 0.0);
		assertEquals(5.5, ServletRequestUtils.getRequiredDoubleParameter(request, "param1"), 0.0);

		assertEquals(6.5, ServletRequestUtils.getDoubleParameter(request, "param2", 6.5), 0.0);
		try {
		...
		assertNull(ServletRequestUtils.getDoubleParameter(request, "param3"));
		assertEquals(6.5, ServletRequestUtils.getDoubleParameter(request, "param3", 6.5), 0.0);
		try {
	...
	public void testBooleanParameter() throws ServletRequestBindingException {
		...
		assertEquals(ServletRequestUtils.getBooleanParameter(request, "param1"), Boolean.TRUE);
		...
		assertNull(ServletRequestUtils.getBooleanParameter(request, "param3"));
	...
	public void testStringParameter() throws ServletRequestBindingException {
		...
		assertNull(ServletRequestUtils.getStringParameter(request, "param3"));
