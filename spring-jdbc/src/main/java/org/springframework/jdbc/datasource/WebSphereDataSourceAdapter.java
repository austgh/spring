...
public class WebSphereDataSourceAdapter extends IsolationLevelDataSourceAdapter {
	...
	private final Class<?> wsDataSourceClass;

	private final Method newJdbcConnSpecMethod;

	private final Method wsDataSourceGetConnectionMethod;

	private final Method setTransactionIsolationMethod;

	private final Method setReadOnlyMethod;

	private final Method setUserNameMethod;

	private final Method setPasswordMethod;
