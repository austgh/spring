...
public class JdbcTemplateTests {
	...
	public void testBeanProperties() throws Exception {
		assertSame("datasource ok", this.template.getDataSource(), this.dataSource);
		assertTrue("ignores warnings by default", this.template.isIgnoreWarnings());
		this.template.setIgnoreWarnings(false);
		assertFalse("can set NOT to ignore warnings", this.template.isIgnoreWarnings());
	}
	...
	public void testUpdateCount() throws Exception {
		...
		assertEquals("1 update affected 1 row", 1, rowsAffected);
	...
	private void doTestStrings(Integer fetchSize, Integer maxRows, Integer queryTimeout,
		...
		assertEquals("same length", forenames.length, results.length);
		for (int i = 0; i < forenames.length; i++) {
			assertEquals("Row " + i + " matches", forenames[i], results[i]);
		}
	...
	public void testSqlUpdate() throws Exception {
		...
		assertEquals("Actual rows affected is correct", actualRowsAffected, rowsAffected);
	...
	public void testBatchUpdateWithEmptyList() throws Exception {
		...
		assertEquals("executed 0 updates", 0, actualRowsAffected.length);
	}
	...
	public void testCaseInsensitiveResultsMap() throws Exception {
		...
		assertFalse("default should have been NOT case insensitive", this.template.isResultsMapCaseInsensitive());
