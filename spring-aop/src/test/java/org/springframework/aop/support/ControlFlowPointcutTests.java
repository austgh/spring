...
public class ControlFlowPointcutTests {
	...
	public void testEqualsAndHashCode() throws Exception {
		...
		assertNotEquals(new ControlFlowPointcut(One.class, "getAge"), new ControlFlowPointcut(One.class));
		...
		assertNotEquals(new ControlFlowPointcut(One.class, "getAge").hashCode(),
