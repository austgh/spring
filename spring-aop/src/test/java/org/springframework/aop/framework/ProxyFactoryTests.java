...
public class ProxyFactoryTests {
	...
	public void testGetsAllInterfaces() throws Exception {
		...
		raw.setAge(25);
		assertEquals(tb.getAge(), raw.getAge());
		...
		assertEquals(ts.getTimeStamp(), t);
		// Shouldn't fail;
	...
	public void testInterceptorInclusionMethods() {
		...
		assertFalse(factory.adviceIncluded(diUnused));
		assertEquals(1, factory.countAdvicesOfType(NopInterceptor.class));
		assertEquals(0, factory.countAdvicesOfType(MyInterceptor.class));

		factory.addAdvice(0, diUnused);
		assertTrue(factory.adviceIncluded(diUnused));
		assertEquals(2, factory.countAdvicesOfType(NopInterceptor.class));
	}
