...
public class CustomizableTraceInterceptorTests {
	...
	public void testSunnyDayPathLogsCorrectlyWithPrettyMuchAllPlaceholdersMatching() throws Throwable {
		...
		CustomizableTraceInterceptor interceptor = new StubCustomizableTraceInterceptor(log);
		interceptor.setEnterMessage("Entering the '" + CustomizableTraceInterceptor.PLACEHOLDER_METHOD_NAME +
				"' method of the [" + CustomizableTraceInterceptor.PLACEHOLDER_TARGET_CLASS_NAME +
				"] class with the following args (" + CustomizableTraceInterceptor.PLACEHOLDER_ARGUMENTS +
				") and arg types (" + CustomizableTraceInterceptor.PLACEHOLDER_ARGUMENT_TYPES +
				").");
		interceptor.setExitMessage("Exiting the '" + CustomizableTraceInterceptor.PLACEHOLDER_METHOD_NAME +
				"' method of the [" + CustomizableTraceInterceptor.PLACEHOLDER_TARGET_CLASS_SHORT_NAME +
				"] class with the following args (" + CustomizableTraceInterceptor.PLACEHOLDER_ARGUMENTS +
				") and arg types (" + CustomizableTraceInterceptor.PLACEHOLDER_ARGUMENT_TYPES +
				"), returning '" + CustomizableTraceInterceptor.PLACEHOLDER_RETURN_VALUE +
				"' and taking '" + CustomizableTraceInterceptor.PLACEHOLDER_INVOCATION_TIME +
				"' this long.");
		interceptor.invoke(methodInvocation);
