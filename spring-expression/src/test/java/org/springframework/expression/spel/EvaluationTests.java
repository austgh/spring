...
public class EvaluationTests extends AbstractExpressionTests {
	...
	public void increment02postfix() {
		...
		assertEquals(new BigDecimal("2"), helper.bd);
		BigDecimal return_bd = e.getValue(ctx, BigDecimal.class);
		assertEquals(new BigDecimal("2"), return_bd);
		assertEquals(new BigDecimal("3"), helper.bd);
	...
	public void increment02prefix() {
		...
		assertEquals(new BigDecimal("2"), helper.bd);
		BigDecimal return_bd = e.getValue(ctx, BigDecimal.class);
		assertEquals(new BigDecimal("3"), return_bd);
		assertEquals(new BigDecimal("3"), helper.bd);
	...
	public void decrement02postfix() {
		...
		BigDecimal return_bd = e.getValue(ctx,BigDecimal.class);
		assertEquals(new BigDecimal("2"), return_bd);
		assertEquals(new BigDecimal("1"), helper.bd);
	...
	public void decrement02prefix() {
		...
		assertEquals(new BigDecimal("2"), helper.bd);
		BigDecimal return_bd = e.getValue(ctx,BigDecimal.class);
		assertEquals(new BigDecimal("1"), return_bd);
		assertEquals(new BigDecimal("1"), helper.bd);
