...
public class CustomEditorTests {
	...
	public void testComplexObject() {
		...
		assertNotNull("spouse is non-null", tb.getSpouse());
	...
	public void testDefaultBooleanEditorForPrimitiveType() {
		...
		assertEquals("Correct bool1 value", Boolean.TRUE, bw.getPropertyValue("bool1"));
		assertTrue("Correct bool1 value", tb.isBool1());

		bw.setPropertyValue("bool1", "false");
		assertEquals("Correct bool1 value", Boolean.FALSE, bw.getPropertyValue("bool1"));
		assertFalse("Correct bool1 value", tb.isBool1());
	...
	public void testDefaultBooleanEditorForWrapperType() {
		...
		assertEquals("Correct bool2 value", Boolean.TRUE, bw.getPropertyValue("bool2"));
		assertTrue("Correct bool2 value", tb.getBool2().booleanValue());

		bw.setPropertyValue("bool2", "false");
		assertEquals("Correct bool2 value", Boolean.FALSE, bw.getPropertyValue("bool2"));
		assertFalse("Correct bool2 value", tb.getBool2().booleanValue());
	...
	public void testCustomBooleanEditorWithAllowEmpty() {
		...
		bw.setPropertyValue("bool2", "");
		assertNull("Correct bool2 value", bw.getPropertyValue("bool2"));
		assertNull("Correct bool2 value", tb.getBool2());
	}
	...
	public void testDefaultNumberEditor() {
		...
		assertEquals("Correct short1 value", new Short("1"), bw.getPropertyValue("short1"));
		assertEquals("Correct short1 value", 1, tb.getShort1());
		assertEquals("Correct short2 value", new Short("2"), bw.getPropertyValue("short2"));
		assertEquals("Correct short2 value", new Short("2"), tb.getShort2());
		assertEquals("Correct int1 value", new Integer("7"), bw.getPropertyValue("int1"));
		assertEquals("Correct int1 value", 7, tb.getInt1());
		assertEquals("Correct int2 value", new Integer("8"), bw.getPropertyValue("int2"));
		assertEquals("Correct int2 value", new Integer("8"), tb.getInt2());
		assertEquals("Correct long1 value", new Long("5"), bw.getPropertyValue("long1"));
		assertEquals("Correct long1 value", 5, tb.getLong1());
		assertEquals("Correct long2 value", new Long("6"), bw.getPropertyValue("long2"));
		assertEquals("Correct long2 value", new Long("6"), tb.getLong2());
		assertEquals("Correct bigInteger value", new BigInteger("3"), bw.getPropertyValue("bigInteger"));
		assertEquals("Correct bigInteger value", new BigInteger("3"), tb.getBigInteger());
		assertEquals("Correct float1 value", new Float("7.1"), bw.getPropertyValue("float1"));
		assertEquals("Correct float1 value", new Float("7.1"), new Float(tb.getFloat1()));
		assertEquals("Correct float2 value", new Float("8.1"), bw.getPropertyValue("float2"));
		assertEquals("Correct float2 value", new Float("8.1"), tb.getFloat2());
		assertEquals("Correct double1 value", new Double("5.1"), bw.getPropertyValue("double1"));
		assertEquals("Correct double1 value", 5.1, tb.getDouble1(), 0.0);
		assertEquals("Correct double2 value", new Double("6.1"), bw.getPropertyValue("double2"));
		assertEquals("Correct double2 value", new Double("6.1"), tb.getDouble2());
		assertEquals("Correct bigDecimal value", new BigDecimal("4.5"), bw.getPropertyValue("bigDecimal"));
		assertEquals("Correct bigDecimal value", new BigDecimal("4.5"), tb.getBigDecimal());
	}
	...
	public void testCustomNumberEditorWithAllowEmpty() {
		...
		assertNull("Correct long2 value", bw.getPropertyValue("long2"));
		assertNull("Correct long2 value", tb.getLong2());
	...
	*/
	...
	public void testCustomDateEditorWithExactDateLength() {
		...
		assertEquals(validDate.length(), maxLength);
		assertNotEquals(invalidDate.length(), maxLength);
