...
public class BeanUtilsTests {
	...
	public void testCopyProperties() throws Exception {
        ...
        assertEquals("Age empty", 0, tb2.getAge());
        assertNull("Touchy empty", tb2.getTouchy());
		BeanUtils.copyProperties(tb, tb2);
        assertEquals("Name copied", tb2.getName(), tb.getName());
        assertEquals("Age copied", tb2.getAge(), tb.getAge());
        assertEquals("Touchy copied", tb2.getTouchy(), tb.getTouchy());
	}
	...
	public void testCopyPropertiesWithEditable() throws Exception {
		TestBean tb = new TestBean();
        assertNull("Name empty", tb.getName());
		tb.setAge(32);
		tb.setTouchy("bla");
		TestBean tb2 = new TestBean();
		tb2.setName("rod");
        ...
        assertNull("Name copied", tb2.getName());
        assertEquals("Age copied", 32, tb2.getAge());
        assertNull("Touchy still empty", tb2.getTouchy());
	}
	...
	public void testCopyPropertiesWithIgnore() throws Exception {
        ...
        assertNull("Name copied", tb2.getName());
        assertEquals("Age still empty", 0, tb2.getAge());
        assertNull("Touchy still empty", tb2.getTouchy());
	}
