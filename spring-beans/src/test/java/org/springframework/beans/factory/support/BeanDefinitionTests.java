...
public class BeanDefinitionTests {
	...
	public void beanDefinitionEquality() {
        ...
        assertFalse(bd.equals(otherBd));
        assertFalse(otherBd.equals(bd));
	...
	public void beanDefinitionHolderEquality() {
        ...
        assertEquals(holder, otherHolder);
        assertEquals(otherHolder, holder);
        assertEquals(holder.hashCode(), otherHolder.hashCode());
	}
