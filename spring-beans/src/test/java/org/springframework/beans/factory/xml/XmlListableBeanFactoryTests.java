...
public class XmlListableBeanFactoryTests extends AbstractListableBeanFactoryTests {
	...
	public void autoAliasing() {
		...
		assertSame(tb2, alias2);
		assertSame(tb2, alias3);
		assertSame(tb2, alias3a);
		assertSame(tb2, alias3b);
		...
		assertSame(tb3, alias4);
		assertSame(tb3, alias5);
	...
	public void factoryNesting() {
		...
		assertNotNull("Bean from root context", father);

		TestBean rod = (TestBean) getBeanFactory().getBean("rod");
		assertEquals("Bean from child context", "Rod", rod.getName());
		assertSame("Bean has external reference", rod.getSpouse(), father);

		rod = (TestBean) parent.getBean("rod");
		assertEquals("Bean from root context", "Roderick", rod.getName());
	}
	...
	public void prototypeReferences() {
		...
		assertNotSame("Not referencing same bean twice", ref2.getTestBean1(), ref2.getTestBean2());
		assertNotSame("Not referencing same bean twice", ref1.getTestBean1(), ref2.getTestBean1());
		assertNotSame("Not referencing same bean twice", ref1.getTestBean2(), ref2.getTestBean2());
		assertNotSame("Not referencing same bean twice", ref1.getTestBean1(), ref2.getTestBean2());
	}
	...
	public void emptyValues() {
		TestBean rod = (TestBean) getBeanFactory().getBean("rod");
		TestBean kerry = (TestBean) getBeanFactory().getBean("kerry");
		assertEquals("Touchy is empty", "", rod.getTouchy());
		assertEquals("Touchy is empty", "", kerry.getTouchy());
	}
