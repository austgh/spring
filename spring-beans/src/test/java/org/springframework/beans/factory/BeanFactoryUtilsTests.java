...
public class BeanFactoryUtilsTests {
	...
	public void testHierarchicalCountBeansWithOverride() throws Exception {
		// Leaf count
        assertEquals(1, this.listableBeanFactory.getBeanDefinitionCount());
		// Count minus duplicate
        assertEquals("Should count 8 beans, not " + BeanFactoryUtils.countBeansIncludingAncestors(this.listableBeanFactory), 8, BeanFactoryUtils.countBeansIncludingAncestors(this.listableBeanFactory));
	}
	...
	public void testHierarchicalNamesWithMatchOnlyInRoot() throws Exception {
        ...
        assertEquals(0, listableBeanFactory.getBeanNamesForType(IndexedTestBean.class).length);
	}
	...
	public void testHierarchicalNamesForAnnotationWithMatchOnlyInRoot() throws Exception {
		...
		// Distinguish from default ListableBeanFactory behavior
        assertEquals(0, listableBeanFactory.getBeanNamesForAnnotation(TestAnnotation.class).length);
	}
