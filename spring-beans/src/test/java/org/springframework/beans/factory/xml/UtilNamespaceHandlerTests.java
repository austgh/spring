...
public class UtilNamespaceHandlerTests {
	...
	public void testNestedCollections() {
		...
		assertNotSame(list, bean2.getSomeList());
		assertNotSame(set, bean2.getSomeSet());
		assertNotSame(map, bean2.getSomeMap());
	}
	...
	public void testNestedShortcutCollections() {
		...
		assertArrayEquals(bean.getStringArray(), bean2.getStringArray());
		assertNotSame(bean.getStringArray(), bean2.getStringArray());
		assertEquals(list, bean2.getSomeList());
		assertEquals(set, bean2.getSomeSet());
		assertNotSame(list, bean2.getSomeList());
		assertNotSame(set, bean2.getSomeSet());
	...
	public void testLoadProperties() {
		...
		assertEquals("Incorrect property value", "bar", props.get("foo"));
		assertNull("Incorrect property value", props.get("foo2"));
