...
public class SubProtocolWebSocketHandlerTests {
	...
	public void setup() {
		...
		given(mqttHandler.getSupportedProtocols()).willReturn(Collections.singletonList("MQTT"));
	...
	public void noSubProtocolOneHandler() throws Exception {
		this.webSocketHandler.setProtocolHandlers(Collections.singletonList(stompHandler));
		this.webSocketHandler.afterConnectionEstablished(session);
	...
	public void checkSession() throws Exception {
		...
		this.webSocketHandler.setProtocolHandlers(Collections.singletonList(this.stompHandler));
