...
public class Jaxb2MarshallerTests extends AbstractMarshallerTests<Jaxb2Marshaller> {
	...
	public void unmarshalStreamSourceWithXmlOptions() throws Exception {
		...
		assertTrue(result.getXMLReader().getFeature("http://apache.org/xml/features/disallow-doctype-decl"));
		assertFalse(result.getXMLReader().getFeature("http://xml.org/sax/features/external-general-entities"));
		...
		assertFalse(result.getXMLReader().getFeature("http://apache.org/xml/features/disallow-doctype-decl"));
		assertTrue(result.getXMLReader().getFeature("http://xml.org/sax/features/external-general-entities"));
	}
	...
	public static class DummyRootElement {
		...
		private final DummyType t = new DummyType();
	}
